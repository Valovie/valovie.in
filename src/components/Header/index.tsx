    ...
    <>
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center ${
          sticky
            ? "dark:bg-[#242222] dark:shadow-sticky-dark shadow-sticky fixed z-9999 bg-white/80 backdrop-blur-xs transition"
      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-end justify-end px-16">
              <div>
                <button
